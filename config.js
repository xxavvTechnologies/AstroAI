export const config = {
    ...
    TOKEN_LIMITS: {
        'development': { tokens: 25000, refreshHours: 2.5 },
        'admin': { tokens: 20000, refreshHours: 2.5 },
        'moderator': { tokens: 15000, refreshHours: 2.5 },
        'premium': { tokens: 12000, refreshHours: 2.5 },
        'basic': { tokens: 8000, refreshHours: 2.5 },
        'trial': { tokens: 5000, refreshHours: 2.5 },
        'beta': { tokens: 10000, refreshHours: 2.5 }
    },
    ACCESS_KEYS: {
        'ASTRO-DEV-2025': {
            type: 'development',
